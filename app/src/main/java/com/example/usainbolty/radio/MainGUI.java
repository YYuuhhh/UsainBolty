...
*/
		...
		LinearLayout.LayoutParams frame_layout_params = new LinearLayout.LayoutParams(pixel_width, ViewGroup.LayoutParams.MATCH_PARENT);
...
// 40000.-399999.
	...
	private void gui_pwr_update(boolean pwr) { // Enables/disables buttons based on power
		if (pwr) {
			...
			Log.d("gfgfgfgfgfgf",m_iv_stop.toString());
